...
const content = {
  ...
  sub_header: 'Last Update: 5/20/2021',
  body: `
    `,
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <h1>Cookie Policy for The Solar Champion</h1>

        <p>
          This is the Cookie Policy for The Solar Champion, accessible from
          www.thesolarchampion.com
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Facebook, LinkedIn and Instagram, will set cookies through our
        ...
        <ul>
          <li>Email: info@championlender.com</li>
        </ul>
      </Modal.Body>
    </Modal>
  )
