...
export default function RefiForm() {
  ...
  watch()
  const MAX_STEPS = 15
  let now = (currentStep / MAX_STEPS) * 100
  const label = `${currentStep} of ${MAX_STEPS}`
  const uri = 'https://chlend.linktrustleadgen.com/Lead/432598/SimplePost'
        ...
        >
          <div className="steps">
            <StyledStepBar>
              ...
              <Col>
                <ProgressBar now={now} label={label} striped animated />
              </Col>
            </StyledStepBar>
            {currentStep === 1 && (
              <div id="step1" className="step">
                <Col>
                  <Row>
                    <Heading
                      heading="Welcome to the Refinance Application"
                      width="60%"
                    />
                  </Row>
                  <Row>
                ...
                <Col>
                  ...
                  <div className="wrap-input">
                    <select
                      ...
                      {...register('state', {
                        required: 'Required',
                        minLength: { value: 2, message: 'Choose your state' },
                      })}
                    >
                      <option value="" defaultValue="NA"></option>
                ...
                <Col>
                  ...
                  <div className="wrap-input">
                    <select
                      ...
                      {...register('best_time')}
                    >
                      <option defaultValue="M">Morning</option>
