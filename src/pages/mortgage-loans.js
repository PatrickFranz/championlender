...
const StyledMortgageLoansPage = styled.div`
  overflow: hidden;
  .text-wrap {
    position: relative;
    min-width: 320px;
        ...
        <Row>
          <Col>
            ...
            <div className="bullets">
              <p>Compare Loan Offers, No Login, No Registration</p>
              <p>Home Value Risen? Tap Into Your Home Equity</p>
              <p>
                <Link to="/reverse-mortgages">
                  Over 62? A Reverse May Be Right for You
                </Link>
              </p>
            </div>
          </Col>
